...
AddEventHandler('::{IlIIIlIIllllIIlIlI}::esx:playerLoaded', function(xPlayer)
	local cash, dirtycash, bank = 0, 0, 0
...
RegisterNetEvent('tempui:SetStats')
AddEventHandler('tempui:SetStats', function(hunger, thirst)
	SendNUIMessage({
		action = 'setStatuts',
		statuts = {
			{
